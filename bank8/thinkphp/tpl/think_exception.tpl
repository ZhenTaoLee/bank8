...
<head>
    ...
    .error_left{ margin: 120px 0 0 50px; width: 330px ; height: 345px; background: url('https://zykj.8haoqianzhuang.cn/76294201806201739074835.png') no-repeat;     background-size: 100%;float: left;}
    ...
    <div class="error_content">
      ...
      <div class="error_right">
        <div class="error_detail">
          <p class="error_p_title">哎呦~ 404!</p>
          <p class="error_p_con">●别急，工程师正在紧急处理，马上就好。</p>
          <p class="error_p_con">●您可致电通知开发人员!</p>
          <p class="error_p_con">●我们的进步需要您的反馈,请您耐心等待!</p>
        </div>
        <!-- <div class="btn_error">
