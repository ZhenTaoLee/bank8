<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/index/view/carex/policyshow.html";i:1530502087;}*/ ?>
...
<body>
    ...
    <!-- <li><a href="/index/Carex/workshow">数据表</a></li>/index/extend/show
    <li><a href="#">基本内容</a></li> -->
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <li>
           ...
           <select onchange="window.location=this.value" class="scinput" >
            ...
            <option value="/index/Carex/policyshow">填表单数据</option>

            <option value="/index/Carex/policyshowclick">下载量数据</option>
