<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/order/sshow.html";i:1530759767;}*/ ?>
    ...
    <table class="tablelist">
       ...
       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>	
        <tr>
            ...
            <td><a href="sow?oid=<?php echo $vo['order_id']; ?>" class="tablelink">分配</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="dist?as=2&oid=<?php echo $vo['order_id']; ?>" class="tablelink">审核不通过</a>&nbsp;&nbsp;<a href="details?id=<?php echo $vo['matching_id']; ?>" class="tablelink">匹配项</a></td>
        </tr>
