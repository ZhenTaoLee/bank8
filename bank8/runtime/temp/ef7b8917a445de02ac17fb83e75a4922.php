<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/index/view/index/newsdetail.html";i:1527045129;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo BACK_CSS_URL; ?>web/newsDetailv1.0.css">
...
<body>
	...
	<main>
		<div class="bg-color">
			<div class="container">
				<div class="row">
					<p class="position">当前位置：<a href="/index/index/journalism/journalism.html">新闻资讯 </a> > <?php echo $list["headline"]; ?></p>
						<div class="col-lg-9 col-md-12 col-xs-12 col-sm-12 bg-white">
							<div class="bg-white content bg-white">
								<div class="title text-center">
									<h4><?php echo $list["headline"]; ?></h4>
									<span><?php echo $list["showtime"]; ?></span>
								</div>
								<div class="news">
									<img src="<?php echo $list["picture"]; ?>" alt="">

									<p><?php echo $list["webtext"]; ?></p>

									<div class="link">
										<div class="upper"><a href="/index/index/journalism/journalism.html" > < 首页</a></div>
										<div class="text-right next"><a href="/index/index/newsdetail?id=<?php echo $data["journalism_id"]; ?>"> 下一条：<?php echo $data["headline"]; ?>></a></div>
									</div>
								</div>
							</div>
							<div class="bg-white content read">
								<div class="h3">
									<h3>相关阅读</h3>
								</div>
									<ul>
										...
										<li>
											...
											<p>
												<span class="left1"><?php echo $vo['headline']; ?></span><span style="float:right"><?php echo $vo['showtime']; ?></span>
											</p>
											</a>
										</li>
										<!-- <li><p><span>国家规定贷款利息高于多少算高利贷呢？</span><span style="float: right">2018-04-20 17:32:25</span></p></li>
										<li><p><span>国家规定贷款利息高于多少算高利贷呢？</span><span style="float: right">2018-04-20 17:32:25</span></p></li>
										<li><p><span>国家规定贷款利息高于多少算高利贷呢？</span><span style="float: right">2018-04-20 17:32:25</span></p></li>
										<li><p><span>国家规定贷款利息高于多少算高利贷呢？</span><span style="float: right">2018-04-20 17:32:25</span></p></li>
										<li><p><span>国家规定贷款利息高于多少算高利贷呢？</span><span style="float: right">2018-04-20 17:32:25</span></p></li> -->
	...
	<footer class="text-center container" style="width: 100%; background-color: #423D47">
		<div class="container" style="padding-top: 20px;padding-bottom: 10px">
			...
			<p style="color: #fff; font-size: 13px;">版权所有广州市中瀛信息科技有限公司/ICP备案号：<a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action;jsessionid=qC41-hFNd8uMSIPcb0E6b67GlknQaSnxyHhTe-Zcnlt8LioAolzG!495133832"  style="color:#377BEE;">粤ICP备17053318号-1</a></p>
