<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/order/gshow.html";i:1530759802;}*/ ?>
       ...
       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>	
        <tr>
           ...
           <!-- <td><?php echo $vo['orderType']; ?></td>-->
            ...
            <td><a href="gow?oid=<?php echo $vo['order_id']; ?>" class="tablelink">分配</a>&nbsp;&nbsp;&nbsp;
            	<a href="dist?as=2&oid=<?php echo $vo['order_id']; ?>" class="tablelink">审核不通过</a>&nbsp;&nbsp;
