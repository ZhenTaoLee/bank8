<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/common/ershow.html";i:1527835194;}*/ ?>
...
<body>
    ...
    <table class="tablelist">
        ...
        <td>
        	...
        	<a href="erupd?id=<?php echo $vo['id']; ?>&ss=1" class="tablelink">变为正常</a>
        	<?php }else{ ?>
 					<a href="erupd?id=<?php echo $vo['id']; ?>&ss=0" class="tablelink">变为审核</a>
 					<?php } ?>
 						&nbsp;&nbsp;&nbsp;
 						
 					<?php if($vo['iosrape']==0){ ?>
        	<a href="erupds?id=<?php echo $vo['id']; ?>&ss=1" class="tablelink">变为强更</a>
        	<?php }else{ ?>
 					<a href="erupds?id=<?php echo $vo['id']; ?>&ss=0" class="tablelink">变为非强更</a>
 					<?php } ?>
        </td>
         ...
         <?php endforeach; endif; else: echo "" ;endif; ?> 
          <tr>
		      ...
		      <td></td>
			   ...
			   <form action="/index.php/back/common/eradd/" method="post">      
        <tr>
