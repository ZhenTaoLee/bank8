<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/school/schoolshow.html";i:1531215158;}*/ ?>
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="schooladd"><li class="click"><span><img src="<?php echo BACK_IMG_URL; ?>t01.png" /></span>添加</li></a>
        <li>
	   		<label></label>
    ...
    <table class="tablelist" style="table-layout: fixed;width: 100 px">
        ...
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['school_id']; ?></td>
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['headline']; ?></td>
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['synopsis']; ?> </td>
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><img src="<?php echo $vo['picture']; ?>" style="height:50px;width:180px;"alt=""> </td>
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['click']; ?> </td>

        <td ><?php echo date('Y-m-d H:i:s',$vo['addtime']);?> </td>
        <td>
          <a href="update?id=<?php echo $vo['school_id']; ?>" class="tablelink"> 编辑</a>
        	<a href="delete?id=<?php echo $vo['school_id']; ?>" class="tablelink" onClick="delcfm()" > 删除</a>
        </td>
