<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/carex/carshow.html";i:1529077967;}*/ ?>
    ...
    <div class="tools">
     ...
     <!--    <li>
           ...
           <select onchange="window.location=this.value" class="scinput" >
            ...
            <option value="/index/Carex/carshow">填表单数据</option>
...
<!--     <div class="tools">
    ...
    <table class="tablelist" style="table-layout: fixed;width: 100 px">
      <thead>
        ...
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['carweb_id']; ?></td>
        ...
        <td>
          <form action="updremark" method="post">
            <input type="hidden" name="id" id="" value="<?php echo $vo['carweb_id']; ?>" />
            ...
            <td>
            <a href="delete?id=<?php echo $vo['carweb_id']; ?>" class="tablelink" onClick="delcfm()" > 删除</a>
          </form>
            <!-- <a href="update?id=<?php echo $vo['carweb_id']; ?>" class="tablelink"> 编辑</a> -->
        </td>
