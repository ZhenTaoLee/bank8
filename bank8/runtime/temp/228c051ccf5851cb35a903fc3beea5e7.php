<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/index/view/carex/workshow.html";i:1530502067;}*/ ?>
    ...
    <div class="tools">
        ...
        <li>
           ...
           <select onchange="window.location=this.value" class="scinput" >
            ...
            <option value="/index/Carex/workshow">填表单数据</option>

            <option value="/index/Carex/workshowclick">下载量数据</option>
