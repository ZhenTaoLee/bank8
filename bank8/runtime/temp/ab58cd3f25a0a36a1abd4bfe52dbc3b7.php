<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/index/view/homepage/database.html";i:1530688114;}*/ ?>
<!DOCTYPE html>
<head lang="en">
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo CSST_URL; ?>database.css">
</head>
<body>
	<div class="container">
		<!-- 问题 -->
	    ...
	    <!-- logo -->
	    <p class="img-text"><img src="<?php echo IMG_URL; ?>school_icon_logo.png">八号钱庄 丨 <span class="time"> <?php echo  date('Y-m-d',$list['addtime']); ?></addtime></span><span class="text-right"><?php echo $list['click']; ?><span class="right">阅读</span></span></p>


	    <!-- 回答 -->
	    <div class="main">
		    <?php echo $list['webtest']; ?>
		</div>
