<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/common/ishow.html";i:1527759429;}*/ ?>
 ...
 <!--       <a href="add"><li class="click"><span><img src="<?php echo BACK_IMG_URL; ?>t01.png" /></span>添加</li></a>-->
    ...
    <table class="tablelist">
       ...
       <td><?php echo $vo['id']; ?></td>
        ...
        <td><?php echo $vo['iosrapeversion']; ?> </td>
        ...
        <td>
        	<a href="iupd?id=<?php echo $vo['id']; ?>" class="tablelink"> 编辑·</a>
