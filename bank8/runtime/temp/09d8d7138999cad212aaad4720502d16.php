<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/policy/workshow.html";i:1529466159;}*/ ?>
...
<body>
  ...
  <div class="place">
    <span>位置：</span>
    <ul class="placeul">
      <li><a href="#"><b>工薪贷表单数据统计</b></a></li>
    <!-- <li><a href="/index/extend/show"><b>旧落地页表单数据统计</b></a></li> -->
    <!-- <li><a href="#">数据表</a></li>/index/extend/show
    <li><a href="#">基本内容</a></li> -->
    </ul>
    </div>
...
<!--
        <li>
           ...
           <select onchange="window.location=this.value" class="scinput" >
            ...
            <option value="/index/Policy/policyshow">填表单数据</option>

            <option value="/index/Carex/carshowclick">下载量数据</option>
...
<!--     <div class="tools">
        ...
        <ul class="toolbar">
            <li><span></span>表单凤凰今日统计：</li>
            <li><span></span><?php echo $fhret; ?></li>
        </ul>

        <ul class="toolbar">
            <li><span></span>表单UC今日统计：</li>
            <li><span></span><?php echo $ucret; ?></li>
        </ul>
        <ul class="toolbar">
            <li><span></span>表单新浪今日统计：</li>
            <li><span></span><?php echo $sinaret; ?></li>
        </ul>
        <ul class="toolbar">
            <li><span></span>表单头条今日统计：</li>
    ...
    <table class="tablelist" style="table-layout: fixed;width: 100 px">
      <thead>
        ...
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['workweb_id']; ?></td>
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['city']; ?></td>
        <!-- <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['brand']; ?></td> -->
        ...
        <td>
          <form action="updremarks" method="post">
            <input type="hidden" name="id" id="" value="<?php echo $vo['workweb_id']; ?>" />
            ...
            <td>
            <a href="delete?id=<?php echo $vo['workweb_id']; ?>" class="tablelink" onClick="delcfm()" > 删除</a>
          </form>
            <!-- <a href="update?id=<?php echo $vo['workweb_id']; ?>" class="tablelink"> 编辑</a> -->
        </td>
