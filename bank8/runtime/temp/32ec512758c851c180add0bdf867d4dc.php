<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/data/wwwroot/default/zuanbaodai/bank8/public/../application/back/view/policy/policyshow.html";i:1529488396;}*/ ?>
...
<!--     <div class="tools">
    ...
    <table class="tablelist" style="table-layout: fixed;width: 100 px">
      <thead>
        ...
        <td style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><?php echo $vo['policyweb_id']; ?></td>
        ...
        <td>
          <form action="updremark" method="post">
            <input type="hidden" name="id" id="" value="<?php echo $vo['policyweb_id']; ?>" />
            ...
            <td>
            <a href="delete?id=<?php echo $vo['policyweb_id']; ?>" class="tablelink" onClick="delcfm()" > 删除</a>
          </form>
            <!-- <a href="update?id=<?php echo $vo['policyweb_id']; ?>" class="tablelink"> 编辑</a> -->
        </td>
