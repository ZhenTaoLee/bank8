...
use \think\Db;
//汽车推广处理类控制器
class Carextend extends Index
{

    //加载凤凰页面
    public function fhcailoan()
    {
      // echo "";
      return $this->fetch();
    }
    ...
    public function sinaextension()
  {
    ...
    public function code()
    {
      // var_dump($_POST);
        ...
        // $tidentity =$_POST['tidentity'];
          ...
          $loge = db('carweb')->where('phone',$phone)->find();
        if($loge){
    ...
    public function fhdownclick()
    {
      ...
      $adder = db('carwebclick')->insert($data);
