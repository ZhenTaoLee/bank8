...
class Policy extends Index
{
  ...
  //加载凤凰页面
  public function fhpolicy()
  {
    return $this->fetch();
  }

  //UC
    public function ucpolicy()
  {
  ...
  public function code()
  {
    // var_dump($_POST);
      ...
      // $tidentity =$_POST['tidentity'];
        $loge = db('policyweb')->where('phone',$phone)->find();
      if($loge){
    ...
    public function fhclick()
    {
      ...
      $adder = db('policywebclick')->insert($data);
